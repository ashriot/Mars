...
const GLYPH_FILES := {
	ControllerType.KEYBOARD_MOUSE: {
		...
		&"terminal_security": "keyboard_1.svg", &"terminal_medical": "keyboard_2.svg",
		&"terminal_finance": "keyboard_3.svg", &"terminal_scan": "keyboard_4.svg",
		&"terminal_extract": "keyboard_5.svg",
		&"shift_left": "keyboard_q.svg", &"shift_right": "keyboard_e.svg",
	},
	ControllerType.XBOX: {
		...
		&"terminal_security": "xbox_button_a.svg", &"terminal_medical": "xbox_button_x.svg",
		&"terminal_finance": "xbox_button_y.svg", &"terminal_scan": "xbox_lb.svg",
		&"terminal_extract": "xbox_rb.svg",
	...
	ControllerType.PLAYSTATION: {
		...
		&"terminal_security": "playstation_button_cross.svg", &"terminal_medical": "playstation_button_square.svg",
		&"terminal_finance": "playstation_button_triangle.svg", &"terminal_scan": "playstation_trigger_l1.svg",
		&"terminal_extract": "playstation_trigger_r1.svg",
		&"shift_left": "playstation_trigger_l2.svg", &"shift_right": "playstation_trigger_r2.svg",
		&"hub_tab_previous": "playstation_trigger_l1.svg", &"hub_tab_next": "playstation_trigger_r1.svg",
		&"hub_page_previous": "playstation_trigger_l2.svg", &"hub_page_next": "playstation_trigger_r2.svg",
	...
	ControllerType.NINTENDO_SWITCH: {
		...
		&"terminal_security": "switch_button_a.svg", &"terminal_medical": "switch_button_y.svg",
		&"terminal_finance": "switch_button_x.svg", &"terminal_scan": "switch_button_l.svg",
		&"terminal_extract": "switch_button_r.svg",
		&"shift_left": "switch_button_zl.svg", &"shift_right": "switch_button_zr.svg",
		&"hub_tab_previous": "switch_button_l.svg", &"hub_tab_next": "switch_button_r.svg",
		&"hub_page_previous": "switch_button_zl.svg", &"hub_page_next": "switch_button_zr.svg",
	...
	ControllerType.STEAM_CONTROLLER: {
		...
		&"terminal_security": "steam_button_a.svg", &"terminal_medical": "steam_button_x.svg",
		&"terminal_finance": "steam_button_y.svg", &"terminal_scan": "controller_button_l1.svg",
		&"terminal_extract": "controller_button_r1.svg",
		&"shift_left": "controller_button_l2.svg", &"shift_right": "controller_button_r2.svg",
		&"hub_tab_previous": "controller_button_l1.svg", &"hub_tab_next": "controller_button_r1.svg",
		&"hub_page_previous": "controller_button_l2.svg", &"hub_page_next": "controller_button_r2.svg",
	...
	ControllerType.STEAM_DECK: {
		...
		&"terminal_security": "steamdeck_button_a.svg", &"terminal_medical": "steamdeck_button_x.svg",
		&"terminal_finance": "steamdeck_button_y.svg", &"terminal_scan": "steamdeck_button_l1.svg",
		&"terminal_extract": "steamdeck_button_r1.svg",
		&"shift_left": "steamdeck_button_l2.svg", &"shift_right": "steamdeck_button_r2.svg",
		&"hub_tab_previous": "steamdeck_button_l1.svg", &"hub_tab_next": "steamdeck_button_r1.svg",
		&"hub_page_previous": "steamdeck_button_l2.svg", &"hub_page_next": "steamdeck_button_r2.svg",
