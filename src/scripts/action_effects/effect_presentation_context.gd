...
var _actor: BattleCombatant
var _target: BattleCombatant
var _action: Action
var _effect_index: int
var _distribution_count: int
var _critical: bool
var _damage_context: DamageContext
var _targets: Array[BattleCombatant]
var _battle_manager: BattleManager
var _is_complete: bool

var actor: BattleCombatant:
	get: return _actor
...
var targets: Array[BattleCombatant]:
	get:
		var copy: Array[BattleCombatant] = []
...
func _init(
	presentation_actor: BattleCombatant,
	presentation_target: BattleCombatant = null,
